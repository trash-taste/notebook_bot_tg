...
from packages.llm import cli
from packages.llm.config import ConfigError, load_settings
...
class CliConfigTests(unittest.TestCase):
    ...
    def test_cli_uses_parser_service_and_prints_json(self) -> None:
        with (
            patch("packages.llm.cli.parse_transcript", return_value=valid_payload()),

...
## Управление задачами в Telegram

Команда `/tasks` или кнопка `✅ Задачи` показывает активные задачи.
Под каждой задачей доступны действия:

- `✅ Выполнено` — закрыть задачу;
- `✏️ Изменить` — заменить название следующим текстовым сообщением;
- `📅 Перенести` — выбрать сегодня, завтра, эту неделю или убрать срок;
